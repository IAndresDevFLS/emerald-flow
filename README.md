...
Quiero que crees el diseno guiandote de esta guia visual:
...
0 1px 3px hsl(215 33% 17% / 0.05),
0 1px 2px -1px hsl(215 33% 17% / 0.05)

Tarjeta elevada

0 8px 24px -4px hsl(215 33% 17% / 0.08),
0 2px 6px -2px hsl(215 33% 17% / 0.05)
...
9. Etiquetas y encabezados de sección
...
18. Fórmula para crear nuevas vistas
...
Quiero cambiar la siguiente vista:

This project was built with [Lovable](https://lovable.dev).

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/be45cccc-583a-4a0e-a548-1e368687f096).
